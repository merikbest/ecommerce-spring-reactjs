...
import com.soap.ecommerce.dto.perfume.PerfumeSearchRequestDto;
...
public class PerfumeControllerTest {
    ...
    public void getPerfume() throws Exception {
        mockMvc.perform(get(TestConstants.URL_PERFUMES_BASIC + "/2"))
                .andExpect(status().isOk())
    ...
    public void getPerfumesByIdsQuery() throws Exception {
        graphQLRequestDto.setQuery(TestConstants.GRAPHQL_QUERY_PERFUMES_BY_IDS);
    ...
    public void getAllPerfumesByQuery() throws Exception {
        graphQLRequestDto.setQuery(TestConstants.GRAPHQL_QUERY_PERFUMES);
    ...
    public void getPerfumeByQuery() throws Exception {
        graphQLRequestDto.setQuery(TestConstants.GRAPHQL_QUERY_PERFUME);
