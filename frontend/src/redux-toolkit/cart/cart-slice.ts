...
export const cartSlice = createSlice({
    ...
    initialState,
    reducers: {
        setCartLoadingState(state, action: PayloadAction<LoadingStatus>) {
...
export const { setCartLoadingState, calculateCartPrice, setCartItemsCount, resetCartState } = cartSlice.actions;
